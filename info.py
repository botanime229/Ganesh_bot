...
# Bot information
SESSION = environ.get('SESSION', 'Ganesh_bot')
API_ID = int(environ.get('API_ID', '20902603'))
API_HASH = environ.get('API_HASH', '79e5caa103a9e9fb0183390b4800845d')
BOT_TOKEN = environ.get('BOT_TOKEN', "8180442558:AAF7F-v21AbyeN3KIkxnC_GxcqxuxFDMwgY")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://i.ibb.co/v4rzZ41/image.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://i.ibb.co/v4rzZ41/image.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002345580767'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6283322330').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002466214823').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002301110911').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002301110911') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002204789508')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002446321972')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002270716029')).split()]
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ganeshcollection')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'jirayamaster_24') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mainchannel2024')
